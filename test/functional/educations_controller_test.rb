...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { activities: @education.activities, degree: @education.degree, end_time: @education.end_time, institution: @education.institution, start_time: @education.start_time }
    end
  ...
  test "should update education" do
    put :update, id: @education, education: { activities: @education.activities, degree: @education.degree, end_time: @education.end_time, institution: @education.institution, start_time: @education.start_time }
    assert_redirected_to education_path(assigns(:education))
  end
